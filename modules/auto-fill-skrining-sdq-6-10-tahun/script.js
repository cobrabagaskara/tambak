(function() {
    ...
    const sdqTemplate = {
        meta: {
            ...
            conditions: {
                ...
                minAge: 6,
                maxAge: 10.99,
                notes: "Template untuk usia 6 sampai kurang dari 11 tahun"
            }
        },
        actions: [
    ...
    function validateAgeAndFillForm() {
        ...
        // Validasi rentang usia: 6 <= usia < 11
        if (usia < 6 || usia >= 11) {
    ...
    function showErrorPopup(title, message) {
        ...
        popup.innerHTML = `
            ...
            <div style="margin-top: 20px; padding: 10px; background: #f8f9fa; border-radius: 8px; font-size: 13px; color: #7f8c8d;">
                ℹ️ Skrining SDQ (Strength and Difficulties Questionnaire) khusus untuk anak usia 6 sampai kurang dari 11 tahun.
            </div>
        `;
    ...
    function fillSDQForm(patientData) {
        console.log('🚀 Memulai auto-fill Skrining SDQ...');
