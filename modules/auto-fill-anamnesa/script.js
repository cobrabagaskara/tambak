(function () {
    ...
    /** Parse tanggal format DD-MM-YYYY [HH:MM:SS] → Date */
    ...
    /** Set value input/textarea + trigger event agar validasi jQuery bereaksi */
    ...
    /** Set value select + trigger change */
    ...
    /** Klik radio button berdasarkan name & value */
    ...
    /** Ekstrak angka dari string seperti "80 mm", "19.35 Kg", "20 /menit" */
    ...
    /** Ekstrak teks dalam kurung siku dari "[0] Mandiri" → "0" */
    ...
    /** Mapping teks popup → value option di form (membuka mata) */
    ...
    /* =========================================================
       PARSING DATA DARI POPUP
    ========================================================= */

    /**
     * Telusuri tabel di dalam panel anamnesa popup,
     * cari baris yang label-nya cocok, ambil nilai dari kolom setelahnya.
     * Tabel menggunakan struktur 6-kolom: label|:|nilai | label|:|nilai
     */
    ...
    /* =========================================================
       AUTO-FILL FORM
       ✅  Field yang BOLEH diisi otomatis:
           PeriksaFisik[*]                        — semua TTV, GCS, Anthropometri, Barthel
           Anamnesa[membutuhkan_bantuan]           — Status Fisis
           Anamnesa[ekspresi_emosi]
           Anamnesa[bahasa_digunakan]
           Anamnesa[tinggal_dengan]
           Anamnesa[sosial_ekonomi]
           Anamnesa[gangguan_jiwa_dimasa_lalu]
           Anamnesa[status_ekonomi]
           Anamnesa[hubungan_keluarga]
           Anamnesa[merokok]                       — Lainnya
           Anamnesa[konsumsi_alkohol]
           Anamnesa[kurang_sayur_buah]
           Anamnesa[terapi]
           Anamnesa[terapi_non_obat]
           Anamnesa[bmhp]
           Anamnesa[edukasi]

       ⛔  Field yang TIDAK PERNAH diisi otomatis:
           Anamnesa[keluhan_utama]   — diisi manual
           Anamnesa[keluhan_tambahan]
           Anamnesa[lama_sakit_*]
           Anamnesa[dokter_id]
           Anamnesa[perawat_id]
    ========================================================= */

    /** Safeguard: blokir field yang harus diisi manual */
    ...
    /* =========================================================
       POLLING POPUP & EKSTRAKSI DATA
    ========================================================= */

    function waitForPopupAndExtract() {
        let polls = 0;
        ...
        const interval = setInterval(() => {
            ...
            // Pastikan tab Anamnesa ada
            const tabAnamnesa = modal.querySelector(CONFIG.TAB_ANAMNESA_SELECTOR);
            if (!tabAnamnesa) return;

            // Klik tab Anamnesa agar aktif
            tabAnamnesa.click();

            // Beri waktu sebentar agar panel Anamnesa ter-render
            setTimeout(() => {
                ...
                // Pastikan panel sudah ada isi (ada tabel Periksa Fisik)
                if (!panel.textContent.includes('Periksa Fisik')) {
                    // Belum load, lanjut polling
                    return;
                }
                ...
                // Tutup popup setelah selesai (opsional — comment jika tidak mau ditutup)
    ...
    /* =========================================================
       CARI KUNJUNGAN PALING BARU SEBELUM HARI INI
    ========================================================= */
    ...
    function findAndClickPreviousVisit() {
        ...
        allLinks.forEach(link => {
            ...
            // Hanya kunjungan SEBELUM hari ini
        ...
        const dateStr = bestDate.toLocaleDateString('id-ID', { day: '2-digit', month: '2-digit', year: 'numeric' });
        showNotif(`🔍 Membuka kunjungan ${dateStr}…`, 'info');
        console.log(`[AutoFill] Klik kunjungan: ${best.textContent.trim()}`);

        best.click();
        waitForPopupAndExtract();
    }
    ...
    function injectButton() {
        ...
        btn.id       = 'autofill-btn';
        btn.type     = 'button';
        btn.textContent = '⚡ Isi dari Kunjungan Sebelumnya';
    ...
    /* =========================================================
       INISIALISASI — tunggu halaman selesai render
    ========================================================= */

    function init() {
        // Tunggu hingga tabel riwayat ada di DOM
        ...
        // Juga coba langsung jika sudah ada
        if (document.querySelector('a.riwayat.btn')) {
            injectButton();
        }
    }
