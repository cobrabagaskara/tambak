(function() {
    ...
    const kankerServiksTemplate = {
        metadata: {
            ...
            conditions: {
                ...
                minAge: 30,
                maxAge: null,
                notes: "Template untuk perempuan usia ≥30 tahun"
            }
        },
        actions: [
    ...
    function checkEligibilityAndShowUI() {
        ...
        if (gender !== "Perempuan") {
            console.log(`🚫 Skrining Kanker Serviks tidak berlaku untuk ${gender}`);
            showEligibilityErrorPopup(
        ...
        if (usia < 30) {
            console.log(`🚫 Skrining Kanker Serviks hanya untuk usia ≥30 tahun (Pasien: ${usia} tahun)`);
            showEligibilityErrorPopup(
                `Skrining Kanker Serviks untuk Usia ≥30 Tahun`,
        ...
        console.log('✅ Skrining Kanker Serviks berlaku untuk pasien ini');
    ...
    function showEligibilityErrorPopup(title, message) {
        ...
        popup.innerHTML = `
            ...
            <div style="margin-top: 20px; padding: 10px; background: #f8f9fa; border-radius: 8px; font-size: 13px; color: #7f8c8d;">
                ℹ️ Skrining Risiko Kanker Serviks direkomendasikan untuk perempuan usia 30 tahun ke atas.
            </div>
        `;
    ...
    function showStartButton(patientData) {
        ...
        button.textContent = '🚀 MULAI AUTO FILL KANKER SERVIKS';
        ...
        console.log('✅ Tombol Auto Fill Kanker Serviks ditampilkan');
    }
    ...
    function fillKankerServiksForm(patientData) {
        console.log('🚀 Memulai auto-fill form Skrining Risiko Kanker Serviks...');
    ...
    function showCompletionPopup(patientData) {
        ...
        popup.innerHTML = `
            ...
            <h2 style="color: #27ae60; margin-bottom: 10px; font-size: 24px; font-weight: 700;">
                ✅ AUTO-FILL KANKER SERVIKS SELESAI
            </h2>
    ...
    function cleanupAllUI() {
        ...
        console.log('🧹 Semua UI Auto Fill Kanker Serviks telah dibersihkan');
    }
