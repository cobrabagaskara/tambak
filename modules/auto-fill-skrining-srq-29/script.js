(function() {
    ...
    // =========================
    // TEMPLATE SKRINING SRQ-29
    // =========================
    const srq29Template = {
        meta: {
            url: "https://cirebon.epuskesmas.id/skriningsrq29/create/",
            skrining: "srq_29",
            judul: "Skrining Self-Reporting Questionnaire-29 (SRQ-29)",
            conditions: {
                gender: "Semua",
                minAge: null,
                maxAge: null,
        ...
        actions: [
            { type: "setRadio", name: "sakit_kepala", value: "0" },
            { type: "setRadio", name: "nafsu_makan", value: "0" },
            { type: "setRadio", name: "tidur_lelap", value: "0" },
            { type: "setRadio", name: "mudah_takut", value: "0" },
            { type: "setRadio", name: "merasa_cemas", value: "0" },
            { type: "setRadio", name: "tangan_gemetar", value: "0" },
            { type: "setRadio", name: "gangguan_pencernaan", value: "0" },
            { type: "setRadio", name: "sulit_berfikir", value: "0" },
            { type: "setRadio", name: "merasa_bahagia", value: "0" },
            { type: "setRadio", name: "sering_menangis", value: "0" },
            { type: "setRadio", name: "sulit_aktifitas", value: "0" },
            { type: "setRadio", name: "keputusan", value: "0" },
            { type: "setRadio", name: "terbengkalai", value: "0" },
            { type: "setRadio", name: "kehidupan", value: "0" },
            { type: "setRadio", name: "kehilangan_minat", value: "0" },
            { type: "setRadio", name: "tidak_bahagia", value: "0" },
            { type: "setRadio", name: "mengakhiri_hidup", value: "0" },
            { type: "setRadio", name: "lelah", value: "0" },
            { type: "setRadio", name: "sakit_perut", value: "1" },  // Satu-satunya yang "1"
            { type: "setRadio", name: "mudah_lelah", value: "0" },
            { type: "setRadio", name: "alkohol_narkoba", value: "0" },
            { type: "setRadio", name: "mencelakai", value: "0" },
            { type: "setRadio", name: "ganguan_pikiran", value: "0" },
            { type: "setRadio", name: "pendengaran", value: "0" },
            { type: "setRadio", name: "mimpi", value: "0" },
            { type: "setRadio", name: "bencana", value: "0" },
            { type: "setRadio", name: "minat", value: "0" },
            { type: "setRadio", name: "berfikir_bencana", value: "0" },
            { type: "setRadio", name: "mengekkpresikan", value: "0" }
        ]
    };
    ...
    function getPatientIdFromUrl() {
        ...
        const match = url.match(/\/skriningsrq29\/create\/(\d+)/);
    ...
    function validateAndFillForm() {
        ...
        console.log(`✅ Skrining SRQ-29 berlaku untuk semua pasien`);

        // Langsung fill form
        fillSRQ29Form(patientData);
    }
    ...
    function showProgress(message) {
        const existing = document.getElementById('srq29Progress');
        if (existing) existing.remove();

        const progressBar = document.createElement('div');
        progressBar.id = 'srq29Progress';
    ...
    function hideProgress() {
        const progressBar = document.getElementById('srq29Progress');
        if (progressBar) {
    ...
    // =========================
    function fillSRQ29Form(patientData) {
        console.log('🚀 Memulai auto-fill Skrining SRQ-29...');

        // Tampilkan progress
        showProgress('Mengisi form SRQ-29...');

        // Auto-fill sesuai template
        srq29Template.actions.forEach((action, index) => {
            setTimeout(() => {
                ...
                if (index === srq29Template.actions.length - 1) {
                    setTimeout(() => {
    ...
    function showCompletionPopup(patientData) {
        ...
        popup.innerHTML = `
            ...
            <div style="background: #f8f9fa; border-radius: 8px; padding: 15px; margin: 20px 0; text-align: left; color: #555; line-height: 1.6;">
                ...
                • 29 pertanyaan telah terisi otomatis<br>
                • 1 jawaban "Ya" (Sakit Perut)<br>
                • 28 jawaban "Tidak"
            </div>
            <p style="color: #555; line-height: 1.7; margin-bottom: 25px; font-size: 14px;">
                Form Skrining SRQ-29 telah terisi otomatis.<br>
    ...
    function cleanupAllUI() {
        ...
        // Hapus progress
        const progress = document.getElementById('srq29Progress');
        if (progress && progress.parentNode) progress.remove();

        console.log('🧹 Semua UI Auto Fill SRQ-29 telah dibersihkan');
    }

    // =========================
    // INIT
    // =========================
    console.log('🟢 Auto Fill Skrining SRQ-29 loaded (29 field, tanpa kondisi)');
