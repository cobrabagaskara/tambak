(function() {
    ...
    // =========================
    // TEMPLATE SKRINING SDQ (6-11 TAHUN)
    // =========================
    const sdqTemplate = {
        meta: {
            url: "https://cirebon.epuskesmas.id/skriningsdq611/create/",
            skrining: "sdq_6_11",
            judul: "Skrining Instrument Strength and Difficulties Questionnaire (SDQ) 6-11 Tahun",
            conditions: {
                gender: "Semua",
                minAge: 6,
                maxAge: 11,
                notes: "Template untuk usia 6-11 tahun"
            }
        },
        actions: [
            ...
            { type: "setRadio", name: "SkriningSdq[q_7]", value: "Agak Benar" },
            ...
            { type: "setRadio", name: "SkriningSdq[q_20]", value: "Tidak Benar" },
    ...
    function getPatientIdFromUrl() {
        ...
        const match = url.match(/\/skriningsdq611\/create\/(\d+)/);
    ...
    function showErrorPopup(title, message) {
        ...
        popup.innerHTML = `
            ...
            <div style="margin-top: 20px; padding: 10px; background: #f8f9fa; border-radius: 8px; font-size: 13px; color: #7f8c8d;">
                ℹ️ Skrining SDQ khusus untuk anak usia 6-11 tahun.
            </div>
        `;
    ...
    function fillSDQForm(patientData) {
        console.log('🚀 Memulai auto-fill Skrining SDQ (6-11 Tahun)...');

        // Tampilkan progress
        showProgress('Mengisi form SDQ...');
    ...
    function showCompletionPopup(patientData) {
        ...
        popup.innerHTML = `
            ...
            <div style="background: #f8f9fa; border-radius: 8px; padding: 15px; margin: 20px 0; text-align: left; color: #555; line-height: 1.6;">
                ...
                Kategori: <span style="color: #9b59b6; font-weight: bold;">6-11 tahun</span>
            </div>
            <p style="color: #555; line-height: 1.7; margin-bottom: 25px; font-size: 14px;">
                Form Skrining SDQ (Strength and Difficulties Questionnaire) telah terisi otomatis.<br>
    ...
    function cleanupAllUI() {
        ...
        console.log('🧹 Semua UI Auto Fill SDQ telah dibersihkan');
    }

    // =========================
    // INIT
    // =========================
    console.log('🟢 Auto Fill Skrining SDQ (6-11 Tahun) loaded');
